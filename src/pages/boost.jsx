...
const Boost = () => {
  return (
    <section className='h-[100dvh] bg-black snap-start relative'>
      <div className='absolute flex items-center gap-10 smlap:flex-col-reverse mdlap:scale-90 mob:scale-100 revsmlap:w-[24vw] top-[50%] right-[50%] -translate-y-[50%] -translate-x-[22%] mob:top-[42%] smlap:w-[300px] smlap:translate-x-[50%] smlap:gap-8 mob:!w-[200px] z-50'>
