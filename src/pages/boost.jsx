...
const Boost = () => {
  return (
    <section className='h-[100dvh] bg-black snap-start relative'>
      <div className='absolute flex items-center gap-10 smlap:flex-col-reverse mdlap:scale-90 revsmlap:w-[24vw] top-[54%] right-[50%] -translate-y-[50%] -translate-x-[22%] smlap:w-[300px] smlap:translate-x-[50%] smlap:gap-8 mob:!w-[200px] z-50'>
      ...
      <img
        ...
        alt="Boost Shoe"
        className='absolute bottom-[34.7%] right-[1.4%] w-[6.5%]'
      />
      <img
        src="/assets/boost-coffee.png" 
        alt="Boost Coffee" 
        className='absolute bottom-[16%] right-[20%] w-[5%]'
      />
      <img
        src="/assets/boost-burger.png" 
        alt="Boost Burger" 
        className='absolute bottom-[35%] right-[26.5%] w-[4.8%]'
      />
      <img
        src="/assets/boost-card.png" 
        alt="Boost Card" 
        className='absolute bottom-[53%] right-[20%] w-[5%]'
      />
      <img
        src="/assets/boost-hand.png" 
        alt="Boost Hand" 
        className='absolute top-[14.5%] right-[13%] w-[4.7%]'
      />
    </section>
  )
}
