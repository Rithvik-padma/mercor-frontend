...
const Investing = () => {
  return (
    <section className='h-[100dvh] bg-[#00D54B] snap-start relative'>
      <div className='absolute w-[100%] top-[50%] left-[50%] -translate-x-[50%] revsmlap:-translate-y-[60%] smlap:top-[3%] flex flex-col gap-16 smlap:gap-12 items-center z-50'>
        <h1 className='text-3xl mob:text-xl font-Agrandir text-white'>
          Investing
        </h1>
        <div className='flex flex-row gap-20 smlap:gap-10 items-center'>
          <div className='flex flex-row gap-8 justify-center items-center smlap:flex-row-reverse'>
